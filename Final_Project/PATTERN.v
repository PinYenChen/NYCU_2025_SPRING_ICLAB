...
begin
    ...
    begin
        ...
        golden_address   = golden_inst[12:0];
        // 
        ...
        else if(golden_opcode === 3'b101)                         Jump_task;
        else 
        begin
...
task Jump_task;
    begin
        $display("Jump_task"); 
        golden_pc = {19'd0, golden_address}-2;
    end
endtask
//golden_pc, golden_curr_pc, cycles, total_cycles, offset = 16'h1000
